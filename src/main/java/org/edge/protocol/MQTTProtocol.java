...
public class MQTTProtocol extends CommonCommuniProtocol {
    ...
    public MQTTProtocol() {
		super(1833,
			new TransportProtocol[] {TransportProtocol.TCP},
			new SecurityProtocol[] {SecurityProtocol.TLS, SecurityProtocol.SSL}, 2, /*256M*/1024*1024*256,
			new Architecture[] {Architecture.REQ_RSP, Architecture.PUB_SUB}, "utf-8", "MQTT",
			new Synchronism[] {Synchronism.SYN, Synchronism.ASYN},
			new QoS[] {QoS.AMO, QoS.ALO, QoS.EO}, BATTERY_DRAINAGE_RATE, TRANSIMISON_SPEED);
    }

...
public class CoAPProtocol extends CommonCommuniProtocol {
	...
	public CoAPProtocol() {
		super(5683,
			new TransportProtocol[] {TransportProtocol.UDP},
			new SecurityProtocol[] {SecurityProtocol.DTLS}, Integer.MAX_VALUE, Integer.MAX_VALUE,
			new Architecture[] {Architecture.REQ_RSP}, "utf-8", "CoAP",
			new Synchronism[] {Synchronism.SYN, Synchronism.ASYN},
			new QoS[] {QoS.CONFIRMABLE}, BATTERY_DRAINAGE_RATE, TRANSIMISON_SPEED);
	}

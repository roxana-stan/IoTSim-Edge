...
public class EdgeLet extends Cloudlet {
	...
	public EdgeLet(final int cloudletId, final long cloudletLength, final int pesNumber,
	...
	public EdgeLet(int cloudletId, double cloudletLength, int pesNumber,
			double cloudletFileSize, double cloudletOutputSize,
